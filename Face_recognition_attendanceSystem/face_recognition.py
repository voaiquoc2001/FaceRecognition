...
class Face_Recognition:
    def __init__(self, root):
        ...
        # Ảnh bên phải
        img_bottom = Image.open(r"Pictures\student.png")
    ...
    def mark_attendance(self, n,r,d,i):
        with open("DanhSach.csv", "r+", newline="\n") as f:    
    ...
    def face_recog(self):
        def draw_boundray(img,classifier, scaleFactor, minNeighbors, color,text, clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence > 77:
                    cv2.putText(img, f"Ma so:{i}", (x,y - 75), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255,255,255), 3)
                    cv2.putText(img, f"Vai Tro:{r}", (x,y - 55), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255,255,255), 3)
                    cv2.putText(img, f"Ho va Ten:{n}", (x,y - 30), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255,255,255), 3)
                    cv2.putText(img, f"Khoa Hoc:{d}", (x,y - 5), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255,255,255), 3)
